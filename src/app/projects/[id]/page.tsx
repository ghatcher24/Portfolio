        ...
        <article className="bg-card p-6 sm:p-8 md:p-10 rounded-lg shadow-xl">
          ...
          {project.id === 'prototype-slitting-machine' && (
            <div className="my-8 flex justify-center">
              <div className="relative w-full max-w-5xl aspect-[2338/710] rounded-lg overflow-hidden shadow-md">
                <Image
                            ...
                            <li key={index}>
                              ...
                              <div className="mt-4 flex justify-center">
                                {step.images.map((image, imgIndex) => {
                                  ...
                                  return (
                                    <div key={imgIndex} className={`relative w-full ${step.title.includes('Untreated Model') ? 'md:w-1/2' : 'md:w-3/5'} ${aspectClass} rounded-lg overflow-hidden shadow-md`}>
                                      <Image
                                        src={image.src}
                                        alt={image.alt}
                                        fill={true}
                          ...
                          return (
                            <li key={index}>
                              ...
                              <div className="mt-4 flex justify-center">
                                {step.images.map((image, imgIndex) => {
                                  return (
                                    <div key={imgIndex} className={`relative w-full md:w-2/5 aspect-[4/3] rounded-lg overflow-hidden shadow-md`}>
                                        <Image
                                          src={image.src}
                                          alt={image.alt}
                                          fill={true}
